...
class App < Sinatra::Base
  ...
  shows = [
      ...
      { id: "a1", name: "Hannibal", image: "img/Hannibal-16x9.jpg", channel: "skyLiving", size: "small" },
      ...
      { id: "a4", name: "Veep", image: "img/Veep-16x9.jpg", channel: "skyAtlantic", size: "medium" },
      { id: "a5", name: "True Detective", image: "img/True-Detective-Colin-16x9.jpg", channel: "skyAtlantic", size: "medium"},
  ]
