...
class App < Sinatra::Base
  ...
  series = [
      ...
      },
      {
        ...
        image: "//dm8eklel4s62k.cloudfront.net/images/small/you-me-and-the-apocalypse-key-art-16x9-e664515.jpg",
        channel: "skyOne",
        size: "medium",
        video: "//static.video.sky.com/skytvguide/2015/08/138523/138523-360p_800K_H264.mp4",
      ...
      },
      {
        type: "series",
        name: "The Flash",
        image: "//dm8eklel4s62k.cloudfront.net/images/medium/the-flash-s2-key-art-16x9-0d11260.jpg",
        channel: "skyOne",
        size: "medium",
        video_image: "//dm8eklel4s62k.cloudfront.net/images/medium/the-flash-S2-16x9-f499e74.jpg",
